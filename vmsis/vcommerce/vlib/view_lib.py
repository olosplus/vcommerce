...
class StandardFormGrid(ModelForm):
    ...
    def save(self, commit = False):
        instance = super(StandardFormGrid, self).save(commit=False)        
#        if hasattr(instance, 'unidade'):
#            instance.unidade = 1
#        elif hasattr(instance, 'empresa'):
#            instance.empresa = 1
        instance.save()       
...
class CreateForm(object):
    ...
    def create_form(self, class_form = StandardFormGrid, GridsData = ""):
...
class ViewCreate(CreateView, AjaxableResponseMixin):  
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.form_class = CreateForm(self.model).create_form(GridsData = grids_data)
