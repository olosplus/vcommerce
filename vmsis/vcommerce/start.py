...
try:
    ...
    #print("\nUnidade...")
    #return_code = subprocess.call('python manage.py loaddata cadastro/fix/unidade.json', shell=True)
    #print("\nAlmoxarifado...")
    #return_code = subprocess.call('python manage.py loaddata cadastro/fix/almoxarifado.json', shell=True)
    #print("\nFuncionário...")
    #return_code = subprocess.call('python manage.py loaddata cadastro/fix/funcionario.json', shell=True)
